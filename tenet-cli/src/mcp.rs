...
impl TenetMcp {
  ...
  #[tool(
    ...
    description = "Submit exactly one authority lifecycle stage: PROPOSAL, RECONCILIATION, CLARIFICATION, or ADMISSION. Every transition is content-addressed and bound to exact Proposal, Reconciliation, and Authority identities; user input is not cryptographic identity."
  )]
